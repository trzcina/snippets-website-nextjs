...
import MediaWithoutInternalAllOf from './MediaWithoutInternalAllOf';
...
class MediaWithoutInternal {
    ...
    constructor(id, url, size, type, source, fileName, mimeType, extension) { 
        AbstractContentTypeSchemaDefinitionWithoutInternal.initialize(this, id);MediaWithoutInternalAllOf.initialize(this);
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            MediaWithoutInternalAllOf.constructFromObject(data, obj);
 ...
 */
MediaWithoutInternal.prototype['externalId'] = undefined;
...
// Implement MediaWithoutInternalAllOf interface:
/**
 * @member {String} url
 */
...
export default MediaWithoutInternal;
