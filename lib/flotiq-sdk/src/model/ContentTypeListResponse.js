...
import ContentTypeListResponseAllOf from './ContentTypeListResponseAllOf';
...
class ContentTypeListResponse {
    ...
    constructor(totalCount, count, totalPages, currentPage) { 
        SystemListProperties.initialize(this, totalCount, count, totalPages, currentPage);ContentTypeListResponseAllOf.initialize(this);
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            ContentTypeListResponseAllOf.constructFromObject(data, obj);
 ...
 */
ContentTypeListResponse.prototype['data'] = undefined;
...
// Implement ContentTypeListResponseAllOf interface:
/**
 * @member {Array.<module:model/ContentTypeDefinitionSchema>} data
 */
...
export default ContentTypeListResponse;
