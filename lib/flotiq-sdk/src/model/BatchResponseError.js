...
import BatchResponseErrorErrors1 from './BatchResponseErrorErrors1';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('errors')) {
                obj['errors'] = ApiClient.convertToType(data['errors'], [BatchResponseErrorErrors1]);
            }
        }
        return obj;
    }
...
export default BatchResponseError;
