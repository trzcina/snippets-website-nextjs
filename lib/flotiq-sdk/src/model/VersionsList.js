...
import VersionsListAllOf from './VersionsListAllOf';
...
class VersionsList {
    ...
    constructor(totalCount, count, totalPages, currentPage) { 
        SystemListProperties.initialize(this, totalCount, count, totalPages, currentPage);VersionsListAllOf.initialize(this);
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            VersionsListAllOf.constructFromObject(data, obj);
...
// Implement VersionsListAllOf interface:
/**
 * @member {Array.<module:model/VersionItem>} data
 */
