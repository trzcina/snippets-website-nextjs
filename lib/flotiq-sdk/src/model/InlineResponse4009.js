    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('schemaDefinition.allOf[1].properties.title.type')) {
                obj['schemaDefinition.allOf[1].properties.title.type'] = ApiClient.convertToType(data['schemaDefinition.allOf[1].properties.title.type'], ['String']);
            }
            if (data.hasOwnProperty('metaDefinition.propertiesConfig.price.label')) {
                obj['metaDefinition.propertiesConfig.price.label'] = ApiClient.convertToType(data['metaDefinition.propertiesConfig.price.label'], ['String']);
            }
            if (data.hasOwnProperty('metaDefinition.propertiesConfig.price.inputType')) {
                obj['metaDefinition.propertiesConfig.price.inputType'] = ApiClient.convertToType(data['metaDefinition.propertiesConfig.price.inputType'], ['String']);
            }
        }
        return obj;
    }
...
export default InlineResponse4009;
