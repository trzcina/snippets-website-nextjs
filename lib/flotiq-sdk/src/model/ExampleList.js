...
import ExampleListAllOf from './ExampleListAllOf';
...
class ExampleList {
    ...
    constructor(totalCount, count, totalPages, currentPage) { 
        SystemListProperties.initialize(this, totalCount, count, totalPages, currentPage);ExampleListAllOf.initialize(this);
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            ExampleListAllOf.constructFromObject(data, obj);
...
// Implement ExampleListAllOf interface:
/**
 * @member {Array.<module:model/Example>} data
 */
