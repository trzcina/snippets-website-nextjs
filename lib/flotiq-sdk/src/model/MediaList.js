...
import MediaListAllOf from './MediaListAllOf';
...
class MediaList {
    ...
    constructor(totalCount, count, totalPages, currentPage) { 
        SystemListProperties.initialize(this, totalCount, count, totalPages, currentPage);MediaListAllOf.initialize(this);
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            MediaListAllOf.constructFromObject(data, obj);
 ...
 */
MediaList.prototype['data'] = undefined;
...
// Implement MediaListAllOf interface:
/**
 * @member {Array.<module:model/Media>} data
 */
