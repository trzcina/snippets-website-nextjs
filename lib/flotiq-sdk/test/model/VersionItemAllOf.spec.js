...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlotiqUserApi.VersionItemAllOf();
  });
  ...
  describe('VersionItemAllOf', function() {
    it('should create an instance of VersionItemAllOf', function() {
      // uncomment below and update the code to test VersionItemAllOf
      //var instance = new FlotiqUserApi.VersionItemAllOf();
      //expect(instance).to.be.a(FlotiqUserApi.VersionItemAllOf);
    });
