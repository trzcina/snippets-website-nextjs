...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlotiqUserApi.MediaVersionsList();
  });
  ...
  describe('MediaVersionsList', function() {
    it('should create an instance of MediaVersionsList', function() {
      // uncomment below and update the code to test MediaVersionsList
      //var instance = new FlotiqUserApi.MediaVersionsList();
      //expect(instance).to.be.a(FlotiqUserApi.MediaVersionsList);
    });
