...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlotiqUserApi.ContentTypeListResponse();
  });
  ...
  describe('ContentTypeListResponse', function() {
    it('should create an instance of ContentTypeListResponse', function() {
      // uncomment below and update the code to test ContentTypeListResponse
      //var instance = new FlotiqUserApi.ContentTypeListResponse();
      //expect(instance).to.be.a(FlotiqUserApi.ContentTypeListResponse);
    });
