...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlotiqUserApi.MediaWithoutInternal();
  });
  ...
  describe('MediaWithoutInternal', function() {
    it('should create an instance of MediaWithoutInternal', function() {
      // uncomment below and update the code to test MediaWithoutInternal
      //var instance = new FlotiqUserApi.MediaWithoutInternal();
      //expect(instance).to.be.a(FlotiqUserApi.MediaWithoutInternal);
    });
