...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlotiqUserApi.VersionItem();
  });
  ...
  describe('VersionItem', function() {
    it('should create an instance of VersionItem', function() {
      // uncomment below and update the code to test VersionItem
      //var instance = new FlotiqUserApi.VersionItem();
      //expect(instance).to.be.a(FlotiqUserApi.VersionItem);
    });
