...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlotiqUserApi.ProjectVersionsList();
  });
  ...
  describe('ProjectVersionsList', function() {
    it('should create an instance of ProjectVersionsList', function() {
      // uncomment below and update the code to test ProjectVersionsList
      //var instance = new FlotiqUserApi.ProjectVersionsList();
      //expect(instance).to.be.a(FlotiqUserApi.ProjectVersionsList);
    });
