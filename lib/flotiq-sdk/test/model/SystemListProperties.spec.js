...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlotiqUserApi.SystemListProperties();
  });
  ...
  describe('SystemListProperties', function() {
    it('should create an instance of SystemListProperties', function() {
      // uncomment below and update the code to test SystemListProperties
      //var instance = new FlotiqUserApi.SystemListProperties();
      //expect(instance).to.be.a(FlotiqUserApi.SystemListProperties);
    });
