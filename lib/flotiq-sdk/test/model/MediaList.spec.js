...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlotiqUserApi.MediaList();
  });
  ...
  describe('MediaList', function() {
    it('should create an instance of MediaList', function() {
      // uncomment below and update the code to test MediaList
      //var instance = new FlotiqUserApi.MediaList();
      //expect(instance).to.be.a(FlotiqUserApi.MediaList);
    });
