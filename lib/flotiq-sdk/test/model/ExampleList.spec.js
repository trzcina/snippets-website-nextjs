...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlotiqUserApi.ExampleList();
  });
  ...
  describe('ExampleList', function() {
    it('should create an instance of ExampleList', function() {
      // uncomment below and update the code to test ExampleList
      //var instance = new FlotiqUserApi.ExampleList();
      //expect(instance).to.be.a(FlotiqUserApi.ExampleList);
    });
