...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlotiqUserApi.ExampleVersionsList();
  });
  ...
  describe('ExampleVersionsList', function() {
    it('should create an instance of ExampleVersionsList', function() {
      // uncomment below and update the code to test ExampleVersionsList
      //var instance = new FlotiqUserApi.ExampleVersionsList();
      //expect(instance).to.be.a(FlotiqUserApi.ExampleVersionsList);
    });
