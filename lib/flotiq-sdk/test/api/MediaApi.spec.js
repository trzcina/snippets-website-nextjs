...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlotiqUserApi.MediaApi();
  });
  ...
  describe('MediaApi', function() {
    ...
    describe('postMedia', function() {
      it('should call postMedia successfully', function(done) {
        //uncomment below and update the code to test postMedia
        //instance.postMedia(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
