...
/**
 * The ExampleVersionsList model module.
 * @module model/ExampleVersionsList
 * @version 2.0.1
 */
var ExampleVersionsList = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ExampleVersionsList</code>.
   * @alias module:model/ExampleVersionsList
   ...
   */
  function ExampleVersionsList(totalCount, count, totalPages, currentPage) {
    _classCallCheck(this, ExampleVersionsList);
    ...
    ExampleVersionsList.initialize(this, totalCount, count, totalPages, currentPage);
  }
  /**
  ...
  _createClass(ExampleVersionsList, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>ExampleVersionsList</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ExampleVersionsList} obj Optional instance to populate.
     * @return {module:model/ExampleVersionsList} The populated <code>ExampleVersionsList</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ExampleVersionsList();
...
ExampleVersionsList.prototype['total_count'] = undefined;
/**
 * @member {Number} count
 */

ExampleVersionsList.prototype['count'] = undefined;
/**
 * @member {Number} total_pages
 */

ExampleVersionsList.prototype['total_pages'] = undefined;
/**
 * @member {Number} current_page
 */

ExampleVersionsList.prototype['current_page'] = undefined;
/**
 * @member {Array.<module:model/VersionItem>} data
 */

ExampleVersionsList.prototype['data'] = undefined; // Implement SystemListProperties interface:
...
var _default = ExampleVersionsList;
